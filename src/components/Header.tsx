        ...
        <header className="!pt-10 !pr-7 !pl-7">
            <div className="flex justify-between gap-1 items-center">
                ...
                <button className="recent">
                    <svg width="40" height="40" viewBox="0 0 30 30" fill="none" className="fill-current text-[#373737ab] dark:text-[#FBFBFB]  transition-all duration-500" xmlns="http://www.w3.org/2000/svg">
